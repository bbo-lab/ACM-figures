...
def get_bounds_markers(nMarkers, joint_marker_order):
    ...
    if marker_name in joint_marker_order:
        ...
        if (cfg.animal_is_large):
            bounds_high[joint_marker_vec_index_use[marker_index], 2] = 0.0 # marker is not allowed to move in plane [ATTENTION: UNCOMMENT THIS FOR THE LARGE ANIMALS]
