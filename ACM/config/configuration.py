...
folder_project = 'dummy_folder' # make this the location of this file
date = 'dummy_date'
task = 'dummy_task'
index_frame_start = 0      
index_frame_end = 0
...
folder_save = folder_project + '/dummy_folder_{:s}_{:s}'.format(task, date)
...
file_labelsDLC = folder_reqFiles + '/' + task + '/dummy_dlc_labels.npy'
...
# POSE RECONSTRUCTION
plot_recon = False
dt = 1 # number of time points to skip between frames
